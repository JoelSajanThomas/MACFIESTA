...
const DEFAULT_DEPARTMENTS: DepartmentItem[] = [
  { id: "dept-mca", name: "Computer Applications (MCA)", code: "MCA", logoUrl: "/MARVEL/ironman.png", description: "Hosts Byte & Code Hackathon, Spider Coding & AI Sprints.", coordinatorName: "Prof. Rajesh Kumar", coordinatorPhone: "+91 94471 11111", facultyName: "Dr. Thomas Varghese", eventCount: 8 },
